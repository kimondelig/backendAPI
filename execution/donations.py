        ...
        query = """
            SELECT
                CONCAT(
                    ...
                    pe.link_id,
                    '/script/netCommerce/customization/pyoCC.js',
                    '?link_id=',
                    pe.link_id,
                    '&distributor_id=',
                    pe.distributor_id,
...
async def main_eventinfo():
    ...
    print('\n')
    print("-" * 50) 
    print('Phase 1: Successfully processed + updated data for DONATIONS!')
